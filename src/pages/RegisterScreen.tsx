        ...
        <div className="w-full max-w-sm animate-fade-in">
          ...
          <div className="flex flex-col gap-3.5">
            ...
            <div>
              ...
              <Input placeholder="you@college.edu" type="email" className="h-11 rounded-xl" />
            </div>
            <div>
              <label className="mb-1 block text-sm font-medium text-foreground">College Name</label>
              <Input placeholder="IIT Delhi" className="h-11 rounded-xl" />
            </div>
            <div>
              <label className="mb-1 block text-sm font-medium text-foreground">Course / Year</label>
              <Input placeholder="B.Tech CSE, 3rd Year" className="h-11 rounded-xl" />
            </div>
            <div>
